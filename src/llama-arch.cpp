...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_PAW_TLUT,                             "mach1.tlut" },    // format constant: unchanged by the PAW rename
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_PAW_TLUT,                 {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_GET_ROWS}}, // paw shared trellis codebook
    {LLM_TENSOR_PAW_NE_TLUT,              {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_GET_ROWS}}, // paw v3 rotated-NE codebook
