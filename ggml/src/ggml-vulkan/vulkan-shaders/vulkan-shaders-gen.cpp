...
void process_shaders() {
    ...
    string_to_spv("paw_embed_rows_f32", "paw_embed_rows.comp", {});
    string_to_spv("paw_ne_mm_f32",      "paw_ne_mm.comp",      {});
    string_to_spv("paw_exp_group_f32",  "paw_exp_group.comp",  {});
    string_to_spv("paw_exp_u_f32",      "paw_exp_u.comp",      {});
    string_to_spv("paw_exp_walk_f32",   "paw_exp_walk.comp",   {});
    string_to_spv("paw_exp_walk_v8_f32", "paw_exp_walk.comp",  {{"PAW_V8", "1"}});
    string_to_spv("paw_rt_u_f32",       "paw_rt_u.comp",       {});
    string_to_spv("paw_rt_walk_f32",    "paw_rt_walk.comp",    {});
    string_to_spv("paw_rt_out_f32",     "paw_rt_out.comp",     {});
    string_to_spv("paw_head_mm_f32",    "paw_head_mm.comp",    {});
    string_to_spv("paw_embed_gather_f32", "paw_embed_gather.comp", {});
    string_to_spv("paw_exp_out_f32",    "paw_exp_out.comp",    {});
    string_to_spv("paw_exp_basis_f32",  "paw_exp_basis.comp",  {});
